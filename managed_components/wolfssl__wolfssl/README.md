...
This is wolfSSL version 5.8.0, published as an Espressif Managed Component.

Included in this library are post-release changes in [PR #8742](https://github.com/wolfSSL/wolfssl/pull/8742).
...
idf.py create-project-from-example "wolfssl/wolfssl^5.8.0:wolfssl_benchmark"
